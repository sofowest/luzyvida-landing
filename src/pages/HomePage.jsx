      ...
      <article id="article-homepage" className="h-vh pt-30 lg:flex lg:pt-[10vh]">
        <div className="flex flex-col h-vh lg:h-full lg:w-[50vw] lg:justify-center lg:items-center lg:px-5">
          <section className='h-[200px] items-center justify-center text-balance px-5 text-[var(--primary-color)] mb-8 relative lg:w-full lg:h-[50vh] lg:flex-col lg:pt-0 lg:px-0 lg:mb-0'>
              ...
              <h1 className="text-[2.1rem] py-3 leading-10 font-(family-name:--font-rubik) font-bold lg:text-[2.8rem] lg:leading-12 lg:relative lg:inset-y-[5%]">Un hogar hecho con mucho amor</h1>
              <h2 className="text-lg w-[75vw] py-3 lg:absolute lg:bottom-[5%] lg:w-full lg:text-2xl">Donde el cuidado se convierte <br className="lg:hidden"/> en calidad de vida</h2>
          </section>
          <section className="items-center justify-center flex h-28 lg:flex-col lg:w-full lg:bottom-0 pt-3">
        ...
        <section className='flex flex-col items-center justify-center w-full h-full py-10'>
          ...
          <div className="grid grid-cols-1 gap-5 m-4 grid-rows-10 md:grid-cols-3 md:grid-rows-6 md:gap-10">
            <div className="w-[80vw] h-[40vh] col-start-1 row-start-1 row-span-2 md:w-[20vw] md:h-[20vw] md:col-start-1 md:row-start-1 md:col-span-1 md:row-span-3 bg-gray-300 rounded-md relative">
              <img src="/imgs/services-1.webp" alt="Empleadas de Luz Y Vida posando para una foto en conjunto" className="w-full h-full object-cover rounded-md"/>
            ...
            <div className="w-[80vw] h-[40vh] col-start-1 row-start-5 row-span-2 md:w-[20vw] md:h-[20vw] md:col-start-3 md:row-start-1 md:col-span-1 md:row-span-3 bg-gray-300 rounded-md relative">
              ...
              <section className="absolute bottom-0 h-[20%] bg-[#7b007bc0] bg-opacity-70 w-full text-center text-[var(--secondary-color)] rounded-b-md flex items-center justify-center">
                <h3 className="text-lg font-bold w-50">Especialistas<br /> en cocina</h3>
              </section>
            </div>
            <div className="w-[80vw] h-[40vh] col-start-1 row-start-7 row-span-2 md:w-[20vw] md:h-[20vw] md:col-start-1 md:row-start-4 md:col-span-1 md:row-span-3 bg-gray-300 rounded-md relative">
              <img src="/imgs/services-4.webp" alt="Empleadas de Luz Y Vida posando para una foto en conjunto" className="w-full h-full object-cover rounded-md"/>
              <section className="absolute bottom-0 h-[20%] bg-[#7b007bc0] bg-opacity-70 w-full text-center text-[var(--secondary-color)] rounded-b-md flex items-center justify-center">
            ...
            <div className="w-[80vw] h-[40vh] col-start-1 row-start-9 row-span-2 md:w-[20vw] md:h-[20vw] md:col-start-2 md:row-start-4 md:col-span-1 md:row-span-3 bg-gray-300 rounded-md relative">
              ...
              <section className="absolute bottom-0 h-[20%] bg-[#7b007bc0] bg-opacity-70 w-full text-center text-[var(--secondary-color)] rounded-b-md flex items-center justify-center">
                <h3 className="text-lg font-bold w-50">Celebración<br /> de días festivos</h3>
              </section>
            </div>
            <div className="w-[80vw] h-[40vh] col-start-1 row-start-11 row-span-2 md:w-[20vw] md:h-[20vw] md:col-start-3 md:row-start-4 md:col-span-1 md:row-span-3 bg-gray-300 rounded-md relative">
              <img src="/imgs/services-6.webp" alt="Empleadas de Luz Y Vida posando para una foto en conjunto" className="w-full h-full object-cover rounded-md"/>
              <section className="absolute bottom-0 h-[20%] bg-[#7b007bc0] bg-opacity-70 w-full text-center text-[var(--secondary-color)] rounded-b-md flex items-center justify-center">
