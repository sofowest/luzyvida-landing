    ...
    <>
      <main>
        <article className="h-dvh">
            <section className='pt-30 pb-5 px-5 text-[var(--primary-color)]'>
            ...
            <section className="width-full h-[50dvh] flex items-center justify-center p-0 scale-125">
                <div class="grid grid-cols-3 md:grid-cols-5 grid-rows-2 md:grid-rows-4 gap-2 md:gap-2">
                  ...
                  <div class="col-start-3 row-start-1 row-span-2 md:col-start-4 md:row-start-1 md:col-span-2 md:row-span-4 bg-gray-300 rounded-md p-10">
                    <img src="" alt="" />
                  </div>
              </div>
            </section>
